...
import Yotam from '../../../public/images/yotam.jpeg';
  ...
  return (
    <div className="intro-container transform -translate-x-64     "> {/* Transparent background */}
      <div className='slide-right  '>
        ...
        {/* middle components */}
        <div className='beech z-20 flex flex-col pt-48 top-48 space-y-6 divide-y divide-white overflow-x-hidden no-scrollbar px-4'>
          <Location />
          <Languages />
          <Skills />
          <Tools />
